<?php
/**
 * Based on https://github.com/yiisoft/yii2-redis/
 */
...
class Redis extends Component
{
    ...
    /**
     * @var string|null the password for establishing DB connection. Defaults to null meaning no AUTH command is sent.
     * See https://redis.io/commands/auth
     */
    public ?string $password = null;
    /**
     * @var integer|null the redis database to use. This is an integer value starting from 0.
     * Defaults to null meaning no SELECT command is sent.
     */
    ...
    public function open()
    {
        ...
        if ($socket) {
            ...
            throw new Exception("Failed to open redis DB connection ($connection): $errorNumber - $errorDescription");
        }
    }
    ...
    {
        $redisCommand = strtoupper(preg_replace('/([A-Z])/', ' \0', $name));
    ...
    private function redirect($redirect, $command, $params)
    {
        ...
        throw new \Exception('No hostname found in redis redirect (MOVED): ');
    }
}
